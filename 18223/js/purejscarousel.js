...
(function() {
  ...
  PureJSCarousel.prototype.build = function() {
    ...
    _.minPos       = (_.carousel.offsetWidth - (_.slides.length *( _.slides[0].offsetWidth+5)));
    ...
    if (_.infinite === true) {
      _.slidesContainer.style.marginLeft = - ((_.slides[0].offsetWidth +5) * _.slides.length) + 'px';
      _.slidesContainer.style.width = ((_.slides[0].offsetWidth +5) * _.slides.length * 3) + 'px';
    } else {
      _.slidesContainer.style.marginLeft = '0px';
      _.slidesContainer.style.width = ((_.slides[0].offsetWidth +5) * _.slides.length) + 'px';
    }
