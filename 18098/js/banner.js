...
document.writeln("    <ul>");
document.writeln("        <li style=\"background:url(images/banner1.jpg) center top no-repeat;\"><a href=\"\" target=\'_blank\'></a></li>");
document.writeln("        <li style=\"background:url(images/banner2.jpg) center top no-repeat;\"><a href=\"\" target=\'_blank\'></a></li>");
document.writeln("        <li style=\"background:url(images/banner3.jpg) center top no-repeat;\"><a href=\"\" target=\'_blank\'></a></li>");
document.writeln("    </ul>");
...
document.writeln("    <dl> ");
document.writeln("       <dd> ");
document.writeln("         <img src='images/I1_ico1.png'><div class='yahei'><strong>废品回收入口</strong></div> ");
document.writeln("       </dd>");
document.writeln("       <dt><img src='images/I1_ico3.png'></dt> ");
document.writeln("       <dd> ");
document.writeln("         <img src='images/I1_ico2.png'><div class='yahei'><strong>我要做回收哥</strong></div> ");
document.writeln("       </dd>");
document.writeln("    </dl>");
document.writeln("   </div>");
document.writeln(" </div>");
