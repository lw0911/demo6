...
//添加收藏夹
function favorite_add_ajax(urlVal,goods_id,obj,more)
{
	$.getJSON(urlVal,{goods_id:goods_id,'more':more,nocache:((new Date()).valueOf())},function(content){
		if(content.isError == false)
		{
