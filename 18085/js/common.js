var com = (function (win, doc) {
    ...
    com.sideMenu = (function (tpl) {
        ...
        var html = "<div class=\"side_menu\">"
                + "        <a href=\"/favorite/\" title=\"我的收藏\"><i class=\"star_ico\"></i><em>我的收藏</em></a>";
            if(ind == "zs")
                html+="        <a href=\"http://www.to8to.com/my/zs_assignment.php\" title=\"积分兑换\"><i class=\"integral_ico\"></i><em>积分兑换</em></a>";
            else if(ind != "sj")
                html+="        <a href=\"http://www.to8to.com/my/creditconvert.php\" title=\"积分兑换\"><i class=\"integral_ico\"></i><em>积分兑换</em></a>";
