...
function reset(){
	img[0].style.width = "165px";
	img[0].style.height = "270px";
	img[0].style.left = "10px";
	
	img[1].style.width = "195px";
	img[1].style.height = "290px";
	img[1].style.left = "156px";
	
	img[2].style.width = "215px";
	img[2].style.height = "330px";
	img[2].style.left = "326px";
	
	img[3].style.width = "195px";
	img[3].style.height = "290px";
	img[3].style.left = "538px";
	
	img[4].style.width = "165px";
	img[4].style.height = "270px";
	img[4].style.left = "720px";
